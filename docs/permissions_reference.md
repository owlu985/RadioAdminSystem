...
| --- | --- |
| admin | `*` (all scopes) |
| manager | `schedule:edit`, `music:edit`, `logs:view`, `users:read`, `news:edit`, `plugins:automation`, `plugins:remote` |
| ops | `schedule:edit`, `logs:view`, `news:edit`, `plugins:automation`, `plugins:remote` |
| viewer | `logs:view` |
