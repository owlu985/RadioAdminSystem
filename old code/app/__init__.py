...
#Init Show pausing restart roll over
	...
	from .routes_logs_api import logs_api_bp
	app.register_blueprint(logs_api_bp)
	from .routes_logs_admin import logs_admin_bp
	app.register_blueprint(logs_admin_bp)
	from .routes_logs_dj import logs_dj_bp
	app.register_blueprint(logs_dj_bp)
