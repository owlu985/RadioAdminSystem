...
def music_search():
    ...
    return finalize_route_metrics("api.music_search", start_time, jsonify(payload), request)
...
def psa_library():
    ...
    return finalize_route_metrics("api.psa_library", start_time, jsonify(payload), request)
