            ...
            "disciplinary": [
                {
                    ...
                    "custom_punishment": rec.custom_punishment,
                    "severity": rec.severity,
                    "notes": rec.notes,
                    "action_taken": rec.action_taken,
                    "effective_at": rec.effective_at.isoformat() if rec.effective_at else None,
                    ...
                    "voided": rec.voided,
                    "voided_by": rec.voided_by,
                    "voided_at": rec.voided_at.isoformat() if rec.voided_at else None,
                    "void_reason": rec.void_reason,
                    "appealed_by": rec.appealed_by,
                    "appealed_at": rec.appealed_at.isoformat() if rec.appealed_at else None,
                    "appeal_notes": rec.appeal_notes,
                    "links": [{"type": link.link_type, "linked_id": link.linked_id, "label": link.label} for link in rec.case_links],
                }
